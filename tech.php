...
<body>
          ...
          <div class="body" id="drop">
            <div class="options row ">
              ...
              <div class="col-sm-4 ">
                ...
                <div class="option-body">
                  <div class="form-check orientation-check">
                    <input class="form-check-input" type="radio" name="orientation" value="left" id="left">
                    <label class="form-check-label" for="left">
                      Left
                    </label>
                  </div>
                  <div class="form-check orientation-check">
                    <input class="form-check-input" type="radio" name="orientation" value="right" id="right">
                ...
                <div id='orientatonError' class='form-text invalid-feedback error'>cxvxvcasd
                </div>
              </div>
              ...
              <div class="col-sm-4">
                ...
                <div class="option-body">
                  <select name="device" class="form-select form-select-sm device-type" aria-label=".form-select-sm example">
  ...
  <script src="assets/js/uploadValidation.js"></script>
</body>
